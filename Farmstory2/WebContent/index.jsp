                ...
                <div>
                    ...
                    <table border="0">
                    	<c:forEach var="latest" items="${latest1}">
	                        <tr>
	                            <td>></td>
	                            <td><a href="/Farmstory2/board/view.do?group=croptalk&cate=grow&seq=${latest.seq}">${latest.title}</a></td>
	                            <td>${latest.rdate}</td>
	                        </tr>
                        </c:forEach>
                    </table>
                ...
                <div>
                    ...
                    <table border="0">
                       	<c:forEach var="latest" items="${latest2}">
	                        <tr>
	                            <td>></td>
	                            <td><a href="/Farmstory2/board/view.do?group=croptalk&cate=school&seq=${latest.seq}">${latest.title}</a></td>
	                            <td>${latest.rdate}</td>
	                        </tr>
                        </c:forEach>
                    </table>
                ...
                <div>
                    ...
                    <table border="0">
                        <c:forEach var="latest" items="${latest3}">
	                        <tr>
	                            <td>></td>
	                            <td><a href="/Farmstory2/board/view.do?group=croptalk&cate=croptalk&seq=${latest.seq}">${latest.title}</a></td>
	                            <td>${latest.rdate}</td>
	                        </tr>
                        </c:forEach>
                    </table>
