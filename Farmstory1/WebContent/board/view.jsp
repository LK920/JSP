    ...
    <script>
        ...
        <section id="board" class="view">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span>[<%= fileBean.getDownload() %>]</span>
                    </td>
                </tr>
                <%} %>
                <tr>
            ...
            <%if(mb.getUid().equals(article.getUid())){ %>
                ...
                <a href="./modify.jsp?group=<%= group %>&cate=<%=cate %>&seq=<%=seq %>" class="btnModify">수정</a>
            <%} %>
                ...
                <article class="comment">
                    ...
                    <div>
                     <%if(mb.getUid().equals(comment.getUid())){ %>
                        <a href="/Farmstory1/board/proc/deleteComment.jsp?group=<%=group %>&cate=<%= cate %>&seq=<%= comment.getSeq() %>&parent=<%= article.getSeq() %>"">삭제</a>
                        <a href="#">수정</a>
                     <% } %>
                    </div>
                </article>
