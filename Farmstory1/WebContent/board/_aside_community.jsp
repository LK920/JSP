            ...
            <section>
                <aside>
                    ...
                    <ul>
                        ...
                        <li class="<%= (cate.equals("cheif")) ? "on":""%>"><a href="./list.jsp?group=community&cate=cheif">나도요리사</a></li>
                        <li class="<%= (cate.equals("qna")) ? "on":""%>"><a href="./list.jsp?group=community&cate=qna">고객문의</a></li>
                        <li class="<%= (cate.equals("fnq")) ? "on":""%>"><a href="./list.jsp?group=community&cate=fnq">자주묻는질문</a></li>
                    </ul>
                </aside>
                <article>
                    <nav>
