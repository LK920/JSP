...
public class SQL {
	//ȸ������
	public final static String SELECT_LOGIN = "SELECT * FROM `JBOARD_MEMBER` WHERE `uid` = ? AND `pass` = PASSWORD(?)";
	...
	public final static String UPDATE_ARTICLE = "UPDATE `JBOARD_ARTICLE` SET `title`=?, `content`=? "
			+ "WHERE `seq`=?";
	public final static String DELETE_ARTCLE = "DELETE FROM `JBOARD_ARTICLE` WHERE `seq`=? OR `parent`=?";
	...
	public final static String UPDATE_FILE_DOWN_COUNT = "UPDATE `JBOARD_FILE` "
